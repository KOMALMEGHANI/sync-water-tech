...
import faqIcon from '../assets/icon/Frequently Asked Questions.png';
      ...
      <section className="relative text-white py-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <img src={faqIcon} alt="Frequently Asked Questions icon" className="h-16 w-16 mx-auto mb-6 opacity-90 object-contain" />
